...
function useIonActionSheet() {
    const controller = useController('IonActionSheet', components.actionSheetController);
...
function useIonAlert() {
    const controller = useController('IonAlert', components.alertController);
...
function useIonToast() {
    const controller = useController('IonToast', components.toastController);
...
function useIonModal(component, componentProps) {
    const controller = useOverlay('IonModal', components.modalController, component, componentProps);
...
function useIonPopover(component, componentProps) {
    const controller = useOverlay('IonPopover', components.popoverController, component, componentProps);
    const present = React.useCallback((options = {}) => {
        controller.present(options);
    }, [controller.present]);
    return [
...
function useIonPicker() {
    const controller = useController('IonPicker', components.pickerController);
...
function useIonLoading() {
    const controller = useController('IonLoading', components.loadingController);
